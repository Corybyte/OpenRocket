...
def calculateNoseConeCG(param):
    ...
    if (foreShoulderLength > MINFEATURE) or (aftShoulderRadius > MINFEATURE):
        ...
        if (isForeShoulderCapped):
            ...
            foreCapCG = common_helper.ringCG(ir, 0, -foreShoulderLength, foreShoulderThickness - foreShoulderLength,
                                             param['density'])
        ...
        if aftShoulderLength > MINFEATURE:
            ...
            aftShoulderCG = common_helper.ringCG(aftShoulderRadius, ir, param['length'],
                                                 param['length'] + aftShoulderLength,
                                                 param['density'])
