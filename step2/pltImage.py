...
def load_params():
    # JSON 
    with open("/data/workspace/myshixun/step2/params.json", "r") as f:
        param = json.load(f)
    return param
...
if __name__ == "__main__":
    ...
    plt.savefig('/data/workspace/myshixun/step2/image/mach.png', dpi=300, bbox_inches='tight')
    ...
    plt.ylabel('CPX')  # 设置 y 轴标签
    plt.savefig('/data/workspace/myshixun/step2/image/aoa.png', dpi=300, bbox_inches='tight')
