import math
from transitionMOI.solution import calculate_Long_moi,calculateLongMOICone,calculate_unit_rot_moi
...
def calculate_moi(param):
    ...
    for n in range(divisions):
        ...
        Ixxo = calculate_unit_rot_moi(r1o, r2o)
        # 表示内部半径梯形台体相对于x轴的单位旋转惯性矩。
        Ixxi = calculate_unit_rot_moi(r1i, r2i)
        # 整个梯形台体相对于x轴的总旋转惯性矩
