...
def process_cp_list(cp_list):
    ...
    for i in range(max_len):
        ...
        result = wholeCP.solution.calculateCP(component_list)
    ...
    plt.savefig('/data/workspace/myshixun/wholeCP/mach.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def process_cp_list2(cp_list):
    ...
    plt.ylabel('CPX')  # 设置 y 轴标签
    plt.savefig('/data/workspace/myshixun/wholeCP/aoa.png', dpi=300, bbox_inches='tight')
    plt.close()
